...
In this `libdogecoin.edl` file we define two different functions.
...
This is the actual host function that the enclave calls into. The function is defined in the `libdogecoin.edl` file and implemented here.
