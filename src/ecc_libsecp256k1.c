...
dogecoin_bool dogecoin_ecc_sign(const uint8_t* private_key, const uint8_t* hash, unsigned char* sigder, size_t* outlen)
{
    assert(secp256k1_ctx);
...
dogecoin_bool dogecoin_ecc_sign_compact(const uint8_t* private_key, const uint8_t* hash, unsigned char* sigder, size_t* outlen)
{
    assert(secp256k1_ctx);
...
dogecoin_bool dogecoin_ecc_verify_sig(const uint8_t* public_key, dogecoin_bool compressed, const uint8_t* hash, unsigned char* sigder, size_t siglen)
{
    assert(secp256k1_ctx);
